...
public class ModRecipeGenerator extends FabricRecipeProvider {
    ...
    public static void addFenceRecipe(RecipeExporter exporter, ItemConvertible fence, ItemConvertible baseBlock) {
    ...
    public static void addFenceGateRecipe(RecipeExporter exporter, ItemConvertible fenceGate, ItemConvertible baseBlock) {
    ...
    public static void addSlabRecipe(RecipeExporter exporter, ItemConvertible slab, ItemConvertible baseBlock) {
    ...
    public static void addStairsRecipe(RecipeExporter exporter, ItemConvertible stair, ItemConvertible baseBlock) {
    ...
    public static void addWallRecipe(RecipeExporter exporter, ItemConvertible wall, ItemConvertible baseBlock) {
